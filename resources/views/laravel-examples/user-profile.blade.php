...
<div>
    <div class="container-fluid">
        ...
        ?>
        <div class="card card-body blur shadow-blur mx-4 mt-n6 pb-4 pt-4 ">
            <div class="row gx-4">
                <div class="col-auto my-auto">
                    <div class="h-100">
                        <h5 class="mb-1">
                            {{ auth()->user()->name }}
                            <span class="badge badge-sm bg-gradient-{{$color}} text-xs">{{auth()->user()->role}}</span>
                        </h5>
                        {{-- <p class="mb-0 font-weight-bold text-sm">
                            {{ __(' CEO / Co-Founder') }} role
                        </p> --}}
                    </div>
                </div>
            </div>
